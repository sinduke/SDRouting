...
public struct RouterView<Content: View>: View, RouterProtocol {
  ...
  public var body: some View {
    ...
    .modalViewModifier(screen: $modal, configuration: modalConfiguration)
   ...
   public func navigateTo<T: View>(
    ...
    let anyDestination = AnyDestination(destination: destinationView)
    switch segue {
    case .push:
  ...
  public func showModal<T: View>(
    ...
    withAnimation(configuration.contentAnimation) {
      self.modal = AnyDestination(destination: content())
    }
  }
